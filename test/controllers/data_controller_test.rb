...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create datum' do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { amount: @datum.amount, author_id: @datum.author_id, name: @datum.name } }
    end
  ...
  test 'should update datum' do
    patch datum_url(@datum),
          params: { datum: { amount: @datum.amount, author_id: @datum.author_id, name: @datum.name } }
